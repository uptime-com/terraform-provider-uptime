...
func (m CheckUDPResourceModel) PrimaryKey() upapi.PrimaryKey {
	return upapi.PrimaryKey(m.ID.ValueInt64())
}

type CheckUDPResourceModelAdapter struct {
...
func (a CheckUDPResourceModelAdapter) Get(ctx context.Context, sg StateGetter) (*CheckUDPResourceModel, diag.Diagnostics) {
	model := *new(CheckUDPResourceModel)
...
func (a CheckUDPResourceModelAdapter) ToAPIArgument(model CheckUDPResourceModel) (*upapi.CheckUDP, error) {
	api := upapi.CheckUDP{
...
func (a CheckUDPResourceModelAdapter) FromAPIResult(api upapi.Check) (*CheckUDPResourceModel, error) {
	model := CheckUDPResourceModel{
...
type CheckUDPResourceAPI struct {
	provider *providerImpl
}

func (m *CheckUDPResourceModel) APIResource() upapi.PrimaryKey {
	return upapi.PrimaryKey(m.ID.ValueInt64())
}

func (c CheckUDPResourceAPI) Create(ctx context.Context, arg upapi.CheckUDP) (*upapi.Check, error) {
	return c.provider.api.Checks().CreateUDP(ctx, arg)
}
...
func (c CheckUDPResourceAPI) Update(ctx context.Context, pk upapi.PrimaryKeyable, arg upapi.CheckUDP) (*upapi.Check, error) {
	return c.provider.api.Checks().UpdateUDP(ctx, pk, arg)
}

func (c CheckUDPResourceAPI) Delete(ctx context.Context, pk upapi.PrimaryKeyable) error {

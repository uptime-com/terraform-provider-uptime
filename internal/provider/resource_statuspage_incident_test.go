		...
		Steps: []resource.TestStep{
			{
				...
				ConfigVariables: config.Variables{
					...
					"updated_at":     config.StringVariable("2025-01-28T00:00:00Z"),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("uptime_statuspage_incident.test", "updates.0.incident_state", "investigating"),
		...
		Steps: []resource.TestStep{
			{
				...
				ConfigVariables: config.Variables{
					...
					"starts_at":                 config.StringVariable("2025-01-28T10:20:00Z"),
					"updated_at":                config.StringVariable("2025-01-28T10:20:00Z"),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("uptime_statuspage.test", "name", name),
					resource.TestCheckResourceAttr("uptime_statuspage_incident.test", "name", incidentName),
					...
					resource.TestCheckResourceAttr("uptime_statuspage_incident.test", "starts_at", "2025-01-28T10:20:00Z"),
					resource.TestCheckResourceAttr("uptime_statuspage_incident.test", "updates.#", "1"),
					resource.TestCheckResourceAttr("uptime_statuspage_incident.test", "updates.0.updated_at", "2025-01-28T10:20:00Z"),
				),
			},
		},
	})

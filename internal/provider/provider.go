...
func (p *providerImpl) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		func() resource.Resource { return NewIntegrationDatadogResource(ctx, p) },
		...
		func() resource.Resource { return NewIntegrationPushbulletResource(ctx, p) },
		func() resource.Resource { return NewIntegrationPushoverResource(ctx, p) },
		func() resource.Resource { return NewIntegrationSlackResource(ctx, p) },
		func() resource.Resource { return NewIntegrationStatusResource(ctx, p) },
		func() resource.Resource { return NewIntegrationStatuspageResource(ctx, p) },
		func() resource.Resource { return NewIntegrationTwitterResource(ctx, p) },
		func() resource.Resource { return NewIntegrationVictoropsResource(ctx, p) },
		func() resource.Resource { return NewIntegrationWavefrontResource(ctx, p) },
		func() resource.Resource { return NewIntegrationWebhookResource(ctx, p) },
		func() resource.Resource { return NewIntegrationZapierResource(ctx, p) },

...
subcategory: ""
description: |-
  Verify SSL certificate validity. Import using the check ID: terraform import uptime_check_sslcert.example 123
---
...
terraform import uptime_check_sslcert.example 123
```
